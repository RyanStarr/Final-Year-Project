...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'Welcome to your vmware environment. ' + status;
...
const GetVirtualMachinesIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'GetVirtualMachinesIntent';
    },
...
const GetStorageIntentHandler = {
    ...
    async handle(handlerInput) {
        const response = await httpGet();
        //const speakOutput = response.fact;
        const speakOutput = 'Storage request made';
        return handlerInput.responseBuilder
            .speak(speakOutput)
            //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
            .getResponse();
...
exports.handler = Alexa.SkillBuilders.custom()
    .addRequestHandlers(
        ...
        GetVirtualMachinesIntentHandler,
